    ...
    if (curPath === '/leads' || curPath.startsWith('/leads?')) {
      ...
      function renderLeadRow(lead) {
        ...
        return '<td class="py-3.5 px-4">' +
          '<div class="flex items-center gap-3">' +
            '<div class="w-9 h-9 rounded-xl bg-orange-100 text-orange-700 font-bold flex items-center justify-center text-xs flex-shrink-0">' + initialLetter + '</div>' +
            '<div>' +
      ...
      function renderMobileCard(lead) {
        ...
        return '<div class="flex items-start justify-between gap-2">' +
          '<div class="flex items-center gap-3">' +
            '<div class="w-10 h-10 rounded-xl bg-orange-100 text-orange-700 font-bold flex items-center justify-center text-sm flex-shrink-0 shadow-xs">' + initialLetter + '</div>' +
            '<div>' +
              '<a href="/leads/' + lead.id + '" class="font-bold text-slate-900 hover:text-orange-600 text-sm block">' + escapeHtml(lead.name) + '</a>' +
