            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                ...
                <div>
                    <div class="flex items-center justify-between mb-1">
                        ...
                        <button type="button" 
                                @click="window.pickMobileContact ? window.pickMobileContact($refs.leadMobileInput, $refs.leadNameInput, { onSuccess: (c) => { mobile = $refs.leadMobileInput.value; onMobileChange(); if(c.name && !name) name = c.name[0]; } }) : null" 
                    ...
                    <div class="relative">
                        <input type="tel" 
                               ...
                               class="w-full text-base sm:text-sm rounded-xl border @error('mobile') border-rose-400 bg-rose-50/30 @else border-slate-300 @enderror focus:border-orange-500 focus:ring-1 focus:ring-orange-500 px-3.5 py-2.5 pr-10 font-medium">
                        <button type="button" 
                                @click="window.pickMobileContact ? window.pickMobileContact($refs.leadMobileInput, $refs.leadNameInput, { onSuccess: (c) => { mobile = $refs.leadMobileInput.value; onMobileChange(); if(c.name && !name) name = c.name[0]; } }) : null" 
                                title="মোবাইল কন্টাক্ট থেকে নম্বর আনুন"
