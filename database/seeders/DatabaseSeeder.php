...
class DatabaseSeeder extends Seeder
{
    public function run(): void
    {
        ...
        ContentItem::create([
            ...
            'caption' => '৩টি সহজ ধাপে আপনার ই-কমার্স ব্যবসা শুরু করুন কোনো স্টক কেনা ছাড়া! বিস্তারিত কমেন্টে।',
        ...
        ContentItem::create([
            ...
            'caption' => 'বাস্তব অভিজ্ঞতার গল্প: কিভাবে শফিকুল ভাই পার্ট-টাইম সময়ে শুরু করে নিজের ক্যারিয়ার গড়ে তুললেন।',
