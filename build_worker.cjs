...
const parts = [
  ...
  '        \'  const dLeads = \' + JSON.stringify(deletedLeadIds) + \';\\n\' +',
  '        \'  dLeads.forEach(id => { document.querySelectorAll("[data-lead-id=\\"" + id + "\\"]").forEach(el => el.remove()); });\\n\' +',
  '        \'  const dNodes = \' + JSON.stringify(deletedNodeIds) + \';\\n\' +',
  '        \'  dNodes.forEach(id => { document.querySelectorAll("[data-node-id=\\"" + id + "\\"]").forEach(el => el.remove()); });\\n\' +',
  '        \'});\\n\' +',
  '        \'</script>\\n\';',
